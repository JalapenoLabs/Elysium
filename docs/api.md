...
| Status | Cause                                                                                 |
|--------|---------------------------------------------------------------------------------------|
| `400`  | Malformed JSON, unknown field, unknown enum value, malformed id in the path, blank or oversized token, refused environment variable key, a call an upstream reads as malformed such as invalid JQL |
